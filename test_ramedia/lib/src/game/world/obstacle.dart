...
class Obstacle extends BodyComponent with ContactCallbacks {
  ...
  Future<void> onLoad() async {
    ...
    add(SpriteComponent()
      ...
      ..size = Vector2.all(4));
    woodCollisionSfx = await AudioPool.create('audio/sfx/wood_collision.mp3', maxPlayers: 4);
  }

  @override
  Body createBody() {
    final shape = PolygonShape();
    final vertices = [Vector2(-2, -2), Vector2(2, -2), Vector2(2, 2), Vector2(-2, 2)];
    shape.set(vertices);
  ...
  void beginContact(Object other, Contact contact) {
    ...
    if (other is Ground || other is Plane || other is Enum) {
